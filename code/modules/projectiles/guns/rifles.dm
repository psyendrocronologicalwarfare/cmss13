...
/obj/item/weapon/gun/rifle/xm51/set_bullet_traits()
	LAZYADD(traits_to_give, list(
		...
		BULLET_TRAIT_ENTRY_ID("breaching", /datum/element/bullet_trait_damage_boost, 4, GLOB.damage_boost_breaching), //340 dmg, enough to 4 tap airlocks, 2 for resin door, 3 for thick resin door
